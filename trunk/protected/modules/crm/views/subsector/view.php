...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Subsector::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('booster.widgets.TbDetailView',array(
	...
	'attributes' => array(
			...
			'value'=>($model->sectorEconomico !== null) ? CHtml::link($model->sectorEconomico, array('/sector/view', 'id' => $model->sectorEconomico->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
