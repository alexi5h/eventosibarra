...
<div class="col-lg-6">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <?php echo $form->dropDownListGroup($model, 'sector_economico_id', array('wrapperHtmlOptions' => array('class' => 'col-sm-12',), 'widgetOptions' => array('data' => array('' => ' -- Seleccione -- ') + CHtml::listData(Sector::model()->findAll(), 'id', Sector::representingColumn()), 'htmlOptions' => array(),))) ?>
        </div>                      
