...
CREATE TABLE IF NOT EXISTS `eventosibarra`.`subsector` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_sector_detalle_sector_economico1_idx` (`sector_economico_id` ASC),
  CONSTRAINT `fk_sector_detalle_sector_economico1`
...
CREATE TABLE IF NOT EXISTS `eventosibarra`.`rama_actividad` (
  ...
  `nombre` VARCHAR(45) NOT NULL,
  `estado` ENUM('ACTIVO','INACTIVO') NOT NULL,
  `sector_detalle_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_detalle_hijo_sector_detalle1_idx` (`sector_detalle_id` ASC),
  CONSTRAINT `fk_detalle_hijo_sector_detalle1`
    FOREIGN KEY (`sector_detalle_id`)
