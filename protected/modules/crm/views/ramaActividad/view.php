...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . RamaActividad::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('booster.widgets.TbDetailView',array(
	...
	'attributes' => array(
			...
			'value'=>($model->sectorDetalle !== null) ? CHtml::link($model->sectorDetalle, array('/subsector/view', 'id' => $model->sectorDetalle->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
